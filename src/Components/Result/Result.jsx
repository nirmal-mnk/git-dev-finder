...
export default function Result() {
  const userData = useSelector(
    (state) => state.rootReducer.searchState.userData
  );
  const isLoading = useSelector(
    (state) => state.rootReducer.searchState.isLoading
  );
  const longDate = (date) => {
  ...
  if (isLoading) {
    return <div className={styles.resultMain}>Loading...</div>;
  } else {
    return (
      <>
        {Object.keys(userData).length ? (
          <div className={styles.resultMain}>
            <div className={styles.profileGeneral}>
              ...
              <div className={styles.proGeneralInfo}>
                <div className={styles.proGeneralInfoTop}>
                  <div className={styles.infoLeft}>
                    <h2>{userData.name}</h2>
                    <p>@{userData.login}</p>
                  </div>
                  <div className={styles.infoRight}>
                    Joined {longDate(userData.created_at)}
                  </div>
                </div>
                <div className={styles.proGeneralInfoBtm}>
                  {userData.bio === null ? (
            ...
            <div className={styles.profileDetail}>
              <div className={styles.profileDetailTop}>
              ...
              <div className={styles.profileDetailBtm}>
                <div className={styles.addDetMain}>
                  <div className={styles.additionalDet}>
                    <svg
                      height="20"
                      width="14"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`${
                        userData.location ? "" : styles.notAvailable
                      }`}
                    >
                      <path
                  ...
                  <div className={styles.additionalDet}>
                    <svg
                      ...
                      width="20"
                      xmlns="http://www.w3.org/2000/svg"
                      className={`${userData.blog ? "" : styles.notAvailable}`}
                    >
                      <path
                ...
                <div className={styles.addDetMain}>
                  <div className={styles.additionalDet}>
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      className={`${
                        userData.twitter_username ? "" : styles.notAvailable
                      }`}
                    >
                      <g fill="#4b6a9b">
                  ...
                  <div className={styles.additionalDet}>
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      className={`${
                        userData.company ? "" : styles.notAvailable
                      }`}
                    >
                      <g fill="#4b6a9b">
